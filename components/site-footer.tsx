    ...
    <footer className="border-t border-border/50 bg-background py-12 md:py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4 lg:grid-cols-5">
          <div className="md:col-span-2 lg:col-span-2 space-y-4">
            ...
            <p className="max-w-xs text-sm text-muted-foreground leading-relaxed">
              Empowering businesses with modern inventory and order management
              solutions. Built for scale, designed for simplicity.
            </p>
        ...
        <div className="mt-12 border-t border-border/50 pt-8 text-center text-xs text-muted-foreground">
          <p>
            © {currentYear} Aliwala Inc. All rights reserved. Designed with
